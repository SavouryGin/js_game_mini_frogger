...
module.exports = {
  ...
  module: {
    rules: [
      ...
      // Загрузка аудио файлов из папки src/sounds
      {
        test: /\.(wav|mp3)$/,
        use: [
          {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        // Путь к папке sounds
        {
          from: path.resolve(environment.paths.source, 'sounds'),
          to: path.resolve(environment.paths.output, 'sounds'),
          toType: 'dir',
        },
      ],
    }),
